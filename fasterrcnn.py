...
Original file is located at
    https://colab.research.google.com/drive/1r186RBF4NZvs2Jx0LVKtoQ_gX7asg_X9
...
trainset = DetectionDataset(
    root='/content/dataset/train',
    meta_path='/content/dataset/train/train_source.csv',
    transform=transform,
    image_processor=None,
    split='train'
)

valset = DetectionDataset(
    root='/content/dataset/train',
    meta_path='/content/dataset/train/train_source.csv',
    transform=transform,
    image_processor=None,
...
testset = DetectionDataset(
    root='/content/dataset/test',
    meta_path='/content/dataset/test/test.csv',
    transform=None,
    image_processor=None,
    split='test'
)
...
with torch.no_grad():
    for image_id, image in tqdm(testset):
        ...
        submit_results['PredictionString'].append(output)